...
ofile='ADCP_150_RIFFRAFT_LECONTE23_20230920T165324_034_000000.mat'
 nofile=['ADCP_150_RIFFRAFT_LECONTE23_20230920T165324_034_000000_proc.mat'];
...
knottom=1/1.9438;
gdata=load('C:\work\LeConte\Data\LeConte_2023\raw\RiffRaft\deploy_20230920_1640\ADCP\150\LeConte_nav_deploy_20230920_1640.mat')
...
ahead(ahead<0)=ahead(ahead<0)+360;2
figure(20)
clf
ax(1)=subplot(3,1,1);
...
title('Ship Heading')
ax(3)=subplot(3,1,3)
plot(data.time,navdata.spdmg,'k.-')
grid on
datetick('x','mm/dd HH:MM','keepticks','keeplimits')
